...
It handles the creation of tensor datasets from the 180x150 data generated by Nicolas Winkler, applies augmentation, and splits the data into training and testing sets. 
...
- initialize():
    Ensures required directories exist and creates tensor datasets from the original data and saved them, if they do not already exist.
