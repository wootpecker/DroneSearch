...
def augment_datasets(dataset=SIMULATIONS[0], amount_samples=32, window_size=None):    
    ...
    print(f"dataset_GDM.shape: {dataset_GDM.shape}")
    ...
    plt.plot(all_coordinates[0][1], all_coordinates[0][0], marker="*", markersize=10, markeredgecolor=color, markerfacecolor=color)
